...
func (element *CloudServer) Load(file string) error {
	if ! existsFile(file) {
...
func (element *CloudServer) Import(file string, format string) error {
	if ! existsFile(file) {
		return  errors.New("File "+file+" doesn't exist!!")
	}
...
func (element *CloudServer) Save(file string) error {
